...
| --advanced-key        | Creating a license key for ESET PROTECT Advanced (1 key - 25 devices)                                      |
...
| --email-api {fakemail, emailfake} | Specify which api to use for mail, default - ```emailfake``` |
